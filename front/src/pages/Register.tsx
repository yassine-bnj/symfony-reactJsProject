...
const Register = () => {
    ...
    const[createsucess, setCreate] = useState<String>('')
              ...
              {createsucess}
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div>
                            ...
                            you have an account! <a   className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={()=>handleNavigate('/login')}>Sign in</a>
                            </p>
                        </form>
                    </div>
                </div>
